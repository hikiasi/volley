  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-sm glass-card p-8 space-y-6">
        <h1 className="text-2xl font-black uppercase text-center italic tracking-tighter">Вход</h1>
        ...
        <div className="text-center text-xs text-white/40">
          Нет аккаунта? <Link href="/auth/signup" className="text-[#FF2D2D] font-bold">Зарегистрироваться</Link>
        </div>
      </div>
    </div>
  );
